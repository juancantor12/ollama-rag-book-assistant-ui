...
export const paths = {
    ...
    exam: {
        ...
        topicsSearch: "/exam/topics/search/",
        evaluate: "/exam/evaluate",
        evaluateCode: "/exam/evaluate_code"
    },
    user: {
...
export const useGenerateEmbeddings = () => {
    ...
    const generateEmbeddings = useCallback((book_filename, { resume = false } = {}) => {
        if (eventSource) {
            eventSource.close()
        }
        const resumeParam = resume ? "?resume=true" : ""
        const es = new EventSource(`${apiUrl}/generate_embeddings/${book_filename}${resumeParam}`, {
